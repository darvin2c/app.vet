...
const mockAttachments = [
  {
    id: 'att_001',
    clinical_record_id: 'medical_record_001',
  ...
  {
    id: 'att_003',
    clinical_record_id: 'medical_record_002',
...
const mockFetchAttachments = async (filters: AttachmentFilters = {}) => {
  ...
  // Aplicar filtros
  if (filters.clinical_record_id) {
    filteredAttachments = filteredAttachments.filter(
      (att) => att.clinical_record_id === filters.clinical_record_id
    )
  }
