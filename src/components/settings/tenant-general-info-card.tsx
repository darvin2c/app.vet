    ...
    <div className="w-full max-w-4xl">
      <form onSubmit={form.handleSubmit(onSubmit)}>
        <FieldSet>
          ...
          <FieldDescription>Datos básicos y contacto del negocio</FieldDescription>
          <FieldSeparator />
          <FieldGroup>
            <Field orientation="responsive">
              <FieldContent>
                <FieldLabel htmlFor="name">Nombre</FieldLabel>
                <FieldDescription>Nombre comercial del tenant</FieldDescription>
              </FieldContent>
            ...
            <Field orientation="responsive">
              <FieldContent>
                ...
                <FieldDescription>Nombre legal de la empresa</FieldDescription>
              </FieldContent>
              <div className="w-full sm:min-w-[300px]">
            ...
            <Field orientation="responsive">
              <FieldContent>
                ...
                <FieldDescription>Número principal de contacto</FieldDescription>
              </FieldContent>
              <div className="w-full sm:min-w-[300px]">
                <Controller
